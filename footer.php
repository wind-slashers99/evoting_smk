  ...
  <div class="footer-top">
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <address>
            <p>SMK TRITECH INFORMATIKA.</p>
            <p class="mb-4">Medan, Indonesia</p>
          ...
          <div class="social-icons">
            ...
            <div class="d-flex">
              ...
              <a href="https://www.instagram.com/_nakhyas/" target="_blank"><i class="mdi mdi-instagram"></i></a>
            </div>
          </div>
        </div>
        <div class="col-sm-6">
    ...
    <div class="container">
      <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
          ...
          <p class="mb-0 text-small pt-1">© 2021-2023. All rights reserved.</p>
        </div>
        <div>
          <div class="d-flex">
