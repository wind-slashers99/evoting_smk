                        ...
                        <form action="kandidat_update.php" method="post" enctype="multipart/form-data">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="<?php echo $d['kandidat_nama'] ?>" required="required"> <input type="hidden" class="form-control" name="id" value="<?php echo $d['kandidat_id'] ?>" required="required">
                                </div>
