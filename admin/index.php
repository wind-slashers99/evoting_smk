        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs">
                <div class="small-box bg-red">
                    <div class="inner">
                        <?php
                        $pemilih = mysqli_query($koneksi, "SELECT * FROM kandidat");
                        ?>
                        <h3><?php echo mysqli_num_rows($pemilih) ?></h3>
                        <p>Kandidat</p>
                    </div>
            ...
            <div class="col-lg-3 col-xs">
                <div class="small-box bg-green">
                    <div class="inner">
                        <?php
                        $pemilih = mysqli_query($koneksi, "SELECT * FROM pemilih WHERE pemilih_id
             IN (SELECT voting_pemilih from voting)");
                        ?>
                        <h3><?php echo mysqli_num_rows($pemilih) ?></h3>
            ...
            <div class="col-lg-3 col-xs">
                <div class="small-box bg-purple">
                    <div class="inner">
                        <?php
                        $pemilih = mysqli_query($koneksi, "SELECT * FROM pemilih WHERE pemilih_id
             NOT IN (SELECT voting_pemilih from voting)");
                        ?>
                        <h3><?php echo mysqli_num_rows($pemilih) ?></h3>
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content" style="padding: 20px;">
                        <div class="chart tab-pane active" id="tab1">
                            ...
                            <br>
                            <canvas id="grafik1" style="position: relative; height: 300px; ">
                                <?php
