                    ...
                    <div class="main-banner">
                        <div class="d-sm-flex justify-content-between">
                            <div class="zoom-in-up">
                                <div class="banner-title">
                                    <h4 class="font-weight-medium">
                                        Sistem Informasi <b>E-Voting</b> Pemilihan Ketua OSIS SMK Tritech Informatika Medan
                                    </h4>
                                </div>
                                <p class="mt-3">
                            ...
                            <div class="mt-5 mt-lg-0">
                                <img src="assets_depan/images/logotritech1.png" alt="marsmello" class="img-fluid" data-aos="zoom-in-up">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row" data-aos="fade-up">
                ...
                <div class="col-sm-4 text-center text-lg-left">
                    <div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        ...
                        <h6 class="text-dark mb-3 mt-4 font-weight-medium">
                            Proses pemilihan lebih  mudah dan cepat
                        </h6>
                    </div>
                </div>
            ...
            <div class="row" data-aos="fade-up">
                <div class="col-sm-4 text-center text-lg-left">
                    <div class="services-box pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        <img src="assets_depan/images/digital-marketing.svg" alt="digital-marketing" data-aos="zoom-in">
                        <h6 class="text-dark mb-3 mt-4 font-weight-medium">
                            Hasil pemilihan lebih cepat keluar
                        </h6>
                    </div>
                </div>
                ...
                <div class="col-sm-4 text-center text-lg-left">
                    <div class="services-box pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        <img src="assets_depan/images/growth-strategy.svg" alt="growth-strategy" data-aos="zoom-in">
                        <h6 class="text-dark mb-3 mt-4 font-weight-medium">
                ...
                <div class="col-sm-4 text-center text-lg-left">
                    <div class="services-box pb-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        <img src="assets_depan/images/saving-strategy.svg" alt="saving-strategy" data-aos="zoom-in">
                        <h6 class="text-dark mb-3 mt-4 font-weight-medium">
                            Hasil lebih akurat
                        </h6>
                    </div>
    ...
    <section class="our-projects" id="projects">
            ...
            <div class="row mb-5">
                <div class="col-sm-12">
                    <div class="d-sm-flex justify-content-between align-items-center mb-2">
                        <h3 class="font-weight-medium text-dark">Silahkan Kembangkan Sesuai Kebutuhan</h3>
                        <div><a href="#" class="btn btn-outline-primary">Klik Saya</a></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="mb-5" data-aos="fade-up">
            <div class="owl-carousel-projects owl-carousel owl-theme">
                <div class="item">
                    <img src="assets_depan/images/carousel/tsld1.jpg" alt="slider">
                </div>
                <div class="item">
                    <img src="assets_depan/images/carousel/tsld2.jpg" alt="slider">
                </div>
                <div class="item">
                    <img src="assets_depan/images/carousel/tsld3.jpg" alt="slider">
                </div>
                <div class="item">
                    <img src="assets_depan/images/carousel/tsld4.jpg" alt="slider">
                </div>
                <div class="item">
                    <img src="assets_depan/images/carousel/tsld5.jpg" alt="slider">
                </div>
                <div class="item">
                    <img src="assets_depan/images/carousel/tsld1.jpg" alt="slider">
                </div>
        ...
        <div class="container">
            <div class="row mt-md-0 mt-lg-4">
                <div class="col-sm-6 text-white" data-aos="fade-up">
                    <p class="font-weight-bold mb-3">testimonial</p>
                    <h3 class="font-weight-medium">Apa kata pemilih<br>dengan adanya e-voting</h3>
                        ...
                        <ul>
                            <li>
                                <div class="testimonial-item">
                                    <img src="assets_depan\images\testimonial\raja.jpg" alt="icon" class="testimonial-icon">
                                    <p>Mempermudah kegiatan pemilihan dan menghemat anggaran.</p>
                                    <h6 class="testimonial-author">Haji raja</h6>
                                    <p class="testimonial-destination">Ketua panitia pemilihan</p>
                                </div>
                            </li>
                            <li>
                                <div class="testimonial-item">
                                    <img src="assets_depan/images/testimonial/feri.jpg" alt="icon" class="testimonial-icons">
                                    <p>Program yang sangat membantu osis dalam kegiatan pemilihan ketua osis.</p>
                                    <h6 class="testimonial-author">Fery IX-X</h6>
                                    <p class="testimonial-destination">Calon ketua osis</p>
                                </div>
                            </li>
                            <li>
                                <div class="testimonial-item">
                                    <img src="assets_depan/images/testimonial/dimas.jpg" alt="icon" class="testimonial-icons">
                                    <p>Program yang bagus dan bermanfaat.</p>
                                    <h6 class="testimonial-author">Dimas slebew</h6>
                                    <p class="testimonial-destination">Panitia pemilihan</p>
                                </div>
                            </li>
                            <li>
                                <div class="testimonial-item">
                                    <img src="assets_depan/images/testimonial/bagas.jpg" alt="icon" class="testimonial-icons">
                                    <p>Sistemnya bagus.</p>
                                    <h6 class="testimonial-author">Nur bagus sholehah</h6>
                                    <p class="testimonial-destination">Siswa</p>
                                </div>
                            </li>
                        </ul>
                    </div>
