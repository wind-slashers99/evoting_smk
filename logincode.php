    ...
    <section class="contactus" id="contact">
        <div class="container">
            ...
            <center>
                ...
                if (isset($_GET['alert'])) {
                    if ($_GET['alert'] == "gagal") {
                        echo "<div class='alert alert-danger'><b>LOGIN GAGAL</b><br>username dan passord salah</div><br/><br/>";
            ...
            <div class="row mb-5 pb-5">
                ...
                <div class="col-sm-7" data-aos="fade-up" data-aos-offset="-500">
                    ...
                    <form action="login_periksa.php" method="POST">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control" placeholder="Password" name="password" required="required" autocomplete="off" id="passwordfield">
                        </div>
                        <button type="submit" class="btn btn-success btn-block btn-flat">MASUK</button>
                    </form>
                    <br>
                    <br>
                    <center><small><b>NB : </b>Silahkan hubungi admin jika anda belum terdaftar sebagai pemilih</small></center>
